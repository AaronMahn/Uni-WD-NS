...
# @jit
def main(eos, iterationss, stepsize, drr=0.1, startingDensity = 1e-14):
    ...
    high_density_eos = eos

    # When you combine EoS they should be in same order and have the same units. Unit conversion is on you, the user.
    combined_eos =eos  #join_eos( low_density_eos=low_density_eos, high_density_eos=high_density_eos)
    ...
    mass_max, radius_max = determine_max_mass(#, rho_c_max, phi_max
